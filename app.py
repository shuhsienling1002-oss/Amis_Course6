...
def show_learning_mode():
    st.markdown("<h2 style='text-align: center;'>Sakaenem: O kakaenen</h2>", unsafe_allow_html=True)
...
# --- 4. 測驗模式 ---
def show_quiz_mode():
    st.markdown("<h2 style='text-align: center;'>🎮 Sakaenem 美食家</h2>", unsafe_allow_html=True)
